...
public partial class ChatViewModel : ViewModelBase
{
    ...
    private async void LoadPreviousChatMessagesAsync()
    {
        ...
        try
        {
            Console.WriteLine("📂 Lade alte Chat-Nachrichten vom Benutzer...");
            ...
            {
                Console.WriteLine("ℹ Keine alten Chat-Sessions gefunden");
                return;
            }
    ...
    private async Task SendAsync()
    {
        ...
        {
            // API aufrufen
            Console.WriteLine($"=== SendAsync: Rufe API für Message auf ===");
